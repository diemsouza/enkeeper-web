...
Você envia o conteúdo da sua aula - texto, imagem ou PDF - e recebe perguntas sobre aquilo ao longo do dia. Responde de cabeça, sem consultar. O sistema avalia, dá feedback e registra o que você acertou e errou.
...
Fluizer mantém sua prática ativa no canal onde você já vive, com o conteúdo que você já está estudando.
...
**Para o professor:**
> Seu aluno estuda 1h por semana com você. Os outros 6 dias e 23 horas, ele esquece. Com o Fluizer, ele pratica todo dia em cima do material que você passou.
...
1. Usuário manda conteúdo da aula - texto, imagem ou PDF.
2. Sistema identifica seções do conteúdo por tipo, detecta o nível e gera perguntas específicas por seção.
...
Ao subir novo conteúdo, o usuário recebe um resumo da atividade anterior: quanto tempo durou, quantas perguntas foram respondidas, acertos e erros, e uma leitura direta do resultado. Fecha o ciclo anterior e contextualiza o novo.

### Onboarding

```
Hi! Bem-vindo ao *Fluizer*. 👋
Manda o conteúdo da sua aula de inglês - texto, foto ou PDF - e recebe perguntas sobre ele ao longo do dia, aqui mesmo.
...
O founder é usuário ativo do próprio produto - estuda inglês com o Fluizer todo dia. Esse é o case real.
...
Founder estuda inglês com o Fluizer todo dia. Reels mostrando o fluxo real - material enviado, perguntas recebidas, evolução semanal. Storytelling de quem construiu para si mesmo.
...
- Resumo da atividade anterior ao adicionar novo conteúdo (com Revisadas)
...
Um agente de prática de inglês que mantém seu vocabulário ativo o dia inteiro no WhatsApp. Você manda o conteúdo da aula, recebe perguntas durante o dia, o sistema avalia e registra o que travou. O que travou volta mais cedo. O que você domina ganha espaço. Toda semana você vê sua evolução real.
