...
### question
fórmula: pergunta direta em EN (até 12 palavras), estrutura simples e mecânica, tipo pedido cru de tradução, pedindo o termo em EN a partir do significado em PT entre aspas, terminando em "in English?".

nota: Banda de nível A2-B1. A resposta é sempre o primeiro termo de answerKeys, os demais são variações aceitas na avaliação e não influenciam a pergunta. O significado entre aspas é a tradução literal desse primeiro termo. Se o significado admitir mais de um termo possível em EN, acrescente detalhe de contexto ou uso até sobrar só um. O enunciado fica um passo abaixo do termo em foco, o esforço do aluno é o termo, não decodificar a pergunta.
...
### question
fórmula: pergunta em EN (até 15 palavras), pedindo o termo em EN a partir do significado em PT entre aspas.
...
exemplo (give up):
- What's the natural way to say "desistir" in English?
